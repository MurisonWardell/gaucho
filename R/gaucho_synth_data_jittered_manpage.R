#' @name gaucho_synth_data_jittered
#' @title gaucho_synth_data_jittered
#' @description A synth data set provided to illustrate how to use gaucho.  
#' See the accompanying vignette for more details.
#' @docType data
#' @format A \code{data.frame} with 90 genes (rows) measured at 4 time points (columns), with added noise.
