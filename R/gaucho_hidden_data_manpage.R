#' @name gaucho_hidden_data
#' @title gaucho_hidden_data
#' @description A synthetic data set provided to illustrate how to use gaucho.  See the accompanying vignette for more details.
#' @docType data
#' @format A \code{data.frame} with 5 mutations (rows) measured at 3 time points (columns)
